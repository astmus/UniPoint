...
namespace MissBot.Abstractions.DataAccess
{
    public interface IJsonRepository : IRepository
    {
        ...
        Task<IMetaCollection<TUnit>> HandleQueryAsync<TUnit>(IUnitRequest<TUnit> query, CancellationToken cancel = default) where TUnit : BaseUnit;
        ...
        Task<TResult> HandleScalarAsync<TResult>(IUnitRequest request, CancellationToken cancel = default);
