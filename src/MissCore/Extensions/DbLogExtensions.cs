...
namespace MissCore.Extensions
{
	public static class OptionsBuilderExtensions
	{
		...
		public static DataOptions UseDefaultLogging(this DataOptions options, IServiceProvider provider)
		{
			...
			return options.UseLoggerFactory(factory);
		}
		...
		internal class LinqToDBLoggerFactoryAdapter
		{
	...
	public static class ServiceConfigurationExtensions
	{
		...
		{
			return serviceCollection.AddLinqToDBContext<IDataContext, DataConnection>(configure, lifetime);
		}
		...
		{
			return serviceCollection.AddLinqToDBContext<TContext, TContext>(configure, lifetime);
		}
