...
{    
    ...
    {       
        ...
        public async override Task HandleAsync(IContext<ChosenInlineResult> context)
        {
        ...
        public abstract Task HandleResultAsync(ChosenInlineResult result, IContext<ChosenInlineResult> context);
        //{
